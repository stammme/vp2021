...
<body>
	...
	<h2>Eesti filmide lisamine</h2>
        ...
        <input type="text" name="title_input" id="title_input" placeholder="filmi pealkiri" value="<?php echo $title_input; ?>"><span>
        ...
        <input type="number" name="duration_input" id="duration_input" min="1" value="60" value="<?php echo $duration_input;?> max="600">
